  ...
  AdministrativeFoodEntity(
    ...
    sources: [
      NationalFoodSource(
        ...
        status: 'Cataloged',
        notes:
            'Open-data packaging is documented, but the official site was under maintenance during verification.',
      ),
    ],
  ),
  AdministrativeFoodEntity(
  ...
  AdministrativeFoodEntity(
    ...
    sources: [
      NationalFoodSource(
        ...
        status: 'Cataloged',
        notes:
            'The current major version is publicly available without license barriers. Importer work is pending.',
      ),
    ],
  ),
  AdministrativeFoodEntity(
  ...
  AdministrativeFoodEntity(
    ...
    sources: [
      NationalFoodSource(
        ...
        status: 'Cataloged',
        notes:
            'Official public database is online. Reuse constraints are stricter than some other sources, so importer work needs a license review first.',
      ),
    ],
  ),
  AdministrativeFoodEntity(
    ...
    sources: [
      NationalFoodSource(
        ...
        latestReleaseLabel: 'Current CREA tables',
        latestReleaseDate: 'rolling',
        status: 'Cataloged',
        notes:
            'Official table portal is confirmed. A stable machine-readable extraction path still needs investigation.',
      ),
    ],
  ),
];
